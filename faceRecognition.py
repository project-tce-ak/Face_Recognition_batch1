...
def train_classifier(faces,faceID):
    face_recognizer=cv2.face.LBPHFaceRecognizer_create() #usinng LBPH face recognizer model
    face_recognizer.train(faces,np.array(faceID))#creating image to a numpy array
